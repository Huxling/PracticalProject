...
while True:
    ...
    def network_programming(num):
        url = 'https://s.taobao.com/search?q=%E7%BC%96%E7%A8%8B%E4%B9%A6%E7%B1%8D&imgfile=&commend=all&ssid=s5-e&search_type=item&sourceId=tb.index&spm=a21bo.21814703.201856-taobao-item.1&ie=utf8&initiative_id=tbindexz_20170306&bcoffset=3&ntoffset=3&p4ppushleft=1%2C48&sort=sale-desc' + str(num)
...
datatmsp.to_csv('shop result.csv', index=False)
